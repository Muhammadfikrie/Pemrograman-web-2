...
<form method="POST" action="#"> <!--Action # unntukmengarahkan kediri sendiri -->
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="custom-control custom-radio custom-control-inline">
        <input name="jenisKelamin" id="jenisKelamin_0" type="radio" class="custom-control-input" value="Laki-laki"> 
  ...
  <div class="form-group row">
    ...
    <div class="col-8"><!--menambhakan [] disetiap nama hobi checkbox itu menjadikannya sebgai array-->
...
$hobi = $_POST['hobi'];
$ipk = $_POST['ipk'];
// print_r($hobi);  (untuk mencetak array)
