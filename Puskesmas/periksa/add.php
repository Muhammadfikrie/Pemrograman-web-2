...
if (isset($_POST["submit"])) {
    ...
    $sql = "INSERT INTO paramedik (tanggal, berat, tinggi, tensi, keterangan, pasien_id, dokter_id) VALUES (?,? ,? ,? ,? ,? ,? ,?)";
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="add.php" method="POST">
                                ...
                                <div class="form-group row">
                                    <label for="paramedik" class="col-4 col-form-label">Dokter</label>
                                    <div class="col-8">
                                        <?php
                                        $sqljenis = "SELECT * FROM paramedik";
                                        $rsjenis = $dbh->query($sqljenis);
                                        ?>
                                        <select id="paramedik" name="paramedik" class="custom-select">
                                            <?php
                                            foreach ($rsjenis as $rowjenis) {
                                            ?>
                                                <option value="<?= $rowjenis['id'] ?>"><?= $rowjenis['nama'] ?></option>
