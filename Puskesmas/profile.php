            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="container">
                                <h4 class="text-center mt-4">Selamat Datang Di Alfiara Medical Center<br />Projek Web 1 - Individu</h4>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        ...
                                                        <div class="text-center">
                                                            <img src="dist/img/Fikri.jpg" class="img-fluid" alt="Profile Image" style="border-radius:10px;">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-8">
