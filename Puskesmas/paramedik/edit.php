...
if (isset($_POST['submit'])) {
    ...
    $data = [$_nama, $_gender, $_tmp_lahir, $_tgl_lahir, $_kategori, $_telpon, $_alamat, $_unit_kerja, $id];
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-8">
                                        <select id="kategori" name="kategori" class="custom-select">
                                            ...
                                            <option value="Saraf" <?= ($row['kategori'] == 'Saraf') ? 'selected' : '' ?>>Saraf</option>
                                            <option value="Bedah" <?= ($row['kategori'] == 'Bedah') ? 'selected' : '' ?>>Bedah</option>
                                            <option value="Mata" <?= ($row['kategori'] == 'Mata') ? 'selected' : '' ?>>Mata</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-8">
                                        <select id="unit_kerja" name="unit_kerja" class="custom-select">
                                            ...
                                            foreach ($rsjenis as $rowjenis) {
                                                $selected = ($row['unit_kerja'] == $rowjenis['id']) ? 'selected' : '';
